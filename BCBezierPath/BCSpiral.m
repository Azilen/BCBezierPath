...
//--------------------------------------------------
BOOL BCLineIntersection(double m1, double b1,
                        double m2, double b2,
                        double *X, double *Y)
{
    if (m1 == m2)
                      ...
                      thetaStep:(CGFloat)thetaStep
{
    ...
    while (oldTheta < endTheta - thetaStep)
    {
        ...
        BOOL result = BCLineIntersection(oldSlope, oldIntercept, newSlope, newIntercept, &outX, &outY);
